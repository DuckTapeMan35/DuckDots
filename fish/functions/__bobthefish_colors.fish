function __bobthefish_colors -S -a color_scheme -d 'Define colors used by bobthefish'
  switch "$color_scheme"
    ...
    case 'terminal' 'terminal-dark*'
      ...
      set -x color_vi_mode_default_reverse  white brblue --bold
      set -x color_vi_mode_insert_reverse   white brgreen --bold
      set -x color_vi_mode_visual_reverse   white bryellow --bold
